...
// TODO: This class will apparently exist in ITK 4.6. When it is released, we should switch to it
...
namespace rpi
{
    ...
    public:
        ...
        itkTypeMacro(TransformToDisplacementFieldFilter, itk::ImageSource);
        ...
        itkConceptMacro(SameDimensionCheck,
                        (itk::Concept::SameDimension<ImageDimension,PixelDimension>));
        itkConceptMacro(DisplacementFieldHasNumericTraitsCheck,
                        (itk::Concept::HasNumericTraits<typename TOutputImage::PixelType::ValueType>));
...
#include "rpiTransformToDisplacementFieldFilter.hxx"
