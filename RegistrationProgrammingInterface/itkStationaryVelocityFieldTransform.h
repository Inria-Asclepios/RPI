...
public:
     ...
     */
    virtual VectorFieldPointerType      GetDisplacementFieldAsVectorField(typename SVFExponentialType::NumericalScheme scheme = SVFExponentialType::SCALING_AND_SQUARING) const;
